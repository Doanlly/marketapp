            ...
            children: [
                  Padding(
                    ...
                    child: Align(
                        ...
                        child: Text("Enter Your Name",style:TextStyle(fontSize:16,color: Colors.black,  fontWeight: FontWeight.w600),)
                    ),
                  ),
               SizedBox(height: 20,),
                TextField(
                  ...
                  decoration: InputDecoration(
                    label: Text("Manish Chutake",style: TextStyle(fontSize: 14,color: Color.fromRGBO(57, 57, 57, 1),),),
              ...
              Padding(
                ...
                child: Align(
                    alignment: Alignment.bottomLeft,
                    child: Text("Add Address",style:TextStyle(fontSize:16,color: Colors.black, fontWeight: FontWeight.w600),)
                ),
              ),
              SizedBox(height: 20),
              TextField(
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context)=> Controller_option()));
                  },
