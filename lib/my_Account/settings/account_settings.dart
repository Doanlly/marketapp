  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Account Setting",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w600),),
      ),
      body: Container(
        child: ListView(
          children: [
              ...
              child: TextButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>Security()));
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 20,),
                      ImageIcon(AssetImage("assets/images/ic_secure.png"),color: Color.fromRGBO(105, 160, 58, 1),),
                      SizedBox(width: 10,),
                      Text("  Security",style: TextStyle(color: Colors.black,fontSize:15 ),),
                    ],
                  )),
            ...
            Container(
              ...
              width: double.infinity,
              child: TextButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> Deactiavate()));
              },
                  child: Row(
                    children: [
                      SizedBox(width: 20,),
                      ImageIcon(AssetImage("assets/images/ic_delete1.png"),color: Color.fromRGBO(105, 160, 58, 1),),
                      SizedBox(width: 10,),
                      Text("  Deactivate Account",style: TextStyle(color: Colors.black,fontSize:15 ),),
                    ],
                  )),
              ...
              child: TextButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> DeleteAccount()));
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 20,),
                      ImageIcon(AssetImage("assets/images/ic_delete2.png"),color: Color.fromRGBO(105, 160, 58, 1),),
                      SizedBox(width: 10,),
