                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        "Buy 1 Get 1 Free fot small sizes",
                                        style: TextStyle(
                                            fontSize: 11.5,
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(10.0),
                                child: Image.asset(
                                  "assets/images/fvd/nhieuqua1.jpg",
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Text(
                                        "Buy 2 kg Get 2200gm Free",
                                        style: TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.w600),
                                      ),
                                      Text(
                                        "Buy 2 Get 1 Free fot small sizes",
                                        style: TextStyle(
                                            fontSize: 11.5,
                                            color: Colors.black26),
                                      ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Text(
                                        "Buy 0.2 kg Get 200gm Free",
                                        style: TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.w600),
                                      ),
                                      Text(
                                        "Buy 1 Get 0 Free fot small sizes",
                                        style: TextStyle(
                                            fontSize: 11.5,
                                            color: Colors.black26),
                                      ),
