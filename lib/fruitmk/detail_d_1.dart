...
class DetailscreenD2 extends StatefulWidget {
  const DetailscreenD2({Key? key, required this.indef}) : super(key: key);

  final IndehiscenDryF indef;
  @override
  State<DetailscreenD2> createState() => _DetailscreenStatez();
}

class _DetailscreenStatez extends State<DetailscreenD2> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: widget.indef.nutrition.length,
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid2.add("${widget.indef.id}");
                            //print("${Listitemproduc}");
                            print("setid2: ${setid2}");
                            for (int i = 0; i < setid2.length; i++) {
                              for (int j = 0; j < indehisdf.length; j++) {
                                if (setid2[i] == "${indehisdf[j].id}") {
                                  savedatadryfruit.add(indehisdf[j].title);
                                  savedatadryfruit.add(indehisdf[j].price);
                                  savedatadryfruit.add(indehisdf[j].image);
                                  savedatadryfruit.add(indehisdf[j].phanloai);
                                }
                              }
                            }
