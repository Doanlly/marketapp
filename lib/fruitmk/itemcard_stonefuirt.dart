                    ...
                    child: InkWell(
                        onTap: () {
                          ...
                          if (checkfavorrite1 == false) {
                            setidf.add("${widget.stonef.id}");
                            //print("${Listitemproduc}");
                            print("setid: ${setidf}");
                            for (int i = 0; i < setidf.length; i++) {
                              for (int j = 0; j < stonefruits.length; j++) {
                                if (setidf[i] == "${stonefruits[j].id}") {
                                  savedataproductf.add(stonefruits[j].title);
                                  savedataproductf.add(stonefruits[j].price);
                                  savedataproductf.add(stonefruits[j].image);
                                  savedataproductf.add(stonefruits[j].phanloai);
                                }
                              }
                            }
