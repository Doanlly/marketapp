...
class DetailscreenV4 extends StatefulWidget {
  const DetailscreenV4({ Key? key, required this.rootvegetablesz}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Align(
                      ...
                      child: Text("${widget.rootvegetablesz.title}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600),))
                    ,),
                  Padding(padding: EdgeInsets.only(left: 25),child:
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text("${widget.rootvegetablesz.detail}",style: TextStyle(fontSize: 14,color: Colors.black54),),
                  )
                    ,),
                      ...
                      itemBuilder: (context,i){
                        return
                          ...
                          Row(children: [
                            ...
                            Text("${widget.rootvegetablesz.nutrition[i]}",style: TextStyle(fontSize: 14,color: Colors.black45),)
                          ],);
                      },),
                  ),
