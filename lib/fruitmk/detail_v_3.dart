...
class DetailscreenV3 extends StatefulWidget {
  const DetailscreenV3({Key? key, required this.alliumvgtt}) : super(key: key);

  final AlliumVegetables alliumvgtt;
  @override
  State<DetailscreenV3> createState() => _DetailscreenStatez();
}

class _DetailscreenStatez extends State<DetailscreenV3> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: widget.alliumvgtt.nutrition.length,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          "${widget.alliumvgtt.price} Per/ kg",
                          style: TextStyle(
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid1.add("${widget.alliumvgtt.id}");
                            print("${Listitemproduc}");
                            print("setid1: ${setid1}");
                            for (int i = 0; i < setid1.length; i++) {
                              for (int j = 0; j < alliumvgt.length; j++) {
                                if (setid1[i] == "${alliumvgt[j].id}") {
                                  savedatavegatables.add(alliumvgt[j].title);
                                  savedatavegatables.add(alliumvgt[j].price);
                                  savedatavegatables.add(alliumvgt[j].image);
                                  savedatavegatables.add(alliumvgt[j].phanloai);
                                }
                              }
                            }
