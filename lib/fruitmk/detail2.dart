...
class Detailscreen2 extends StatefulWidget {
  const Detailscreen2({Key? key, required this.stonef}) : super(key: key);
  final StoneFruits stonef;
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: widget.stonef.nutrition.length,
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid.add("${widget.stonef.id}");
                            print("${Listitemproduc}");
                            print("setid: ${setid}");
                            for (int i = 0; i < setid.length; i++) {
                              for (int j = 0; j < stonefruits.length; j++) {
                                if (setid[i] == "${stonefruits[j].id}") {
                                  savedataproduct.add(stonefruits[j].title);
                                  savedataproduct.add(stonefruits[j].price);
                                  savedataproduct.add(stonefruits[j].image);
                                  savedataproduct.add(stonefruits[j].phanloai);
                                }
                              }
                            }
