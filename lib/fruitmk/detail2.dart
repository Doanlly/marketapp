              ...
              children: [
                ...
                Padding(padding: EdgeInsets.only(top: 20,bottom: 13),child:
                  Align(
                      ...
                      child: Text("${widget.stonef.title}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600),))
                  ,),
                Padding(padding: EdgeInsets.only(left: 25),child:
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text("${widget.stonef.detail}",style: TextStyle(fontSize: 14,color: Colors.black54),),
                  )
                  ,),
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context,i){
                      ...
                      Text("${widget.stonef.nutrition[i]}",style: TextStyle(fontSize: 14,color: Colors.black45),)
                      ],);
                    },),
                ),
