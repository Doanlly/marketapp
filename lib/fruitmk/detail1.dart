...
class Detailscreenz extends StatefulWidget {
  const Detailscreenz({Key? key, required this.mixed}) : super(key: key);

  final MixedFruits mixed;
  @override
  State<Detailscreenz> createState() => _DetailscreenStatez();
}

class _DetailscreenStatez extends State<Detailscreenz> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: widget.mixed.nutrition.length,
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid.add("${widget.mixed.id}");
                            print("${Listitemproduc}");
                            print("setid: ${setid}");
                            for (int i = 0; i < setid.length; i++) {
                              for (int j = 0; j < mfruits.length; j++) {
                                if (setid[i] == "${mfruits[j].id}") {
                                  savedataproduct.add(mfruits[j].title);
                                  savedataproduct.add(mfruits[j].price);
                                  savedataproduct.add(mfruits[j].image);
                                  savedataproduct.add(mfruits[j].phanloai);
                                }
                              }
                            }
