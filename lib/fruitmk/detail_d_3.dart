                    ...
                    itemBuilder: (context, i) {
                      return
                        ...
                        children: [
                          ...
                          Text(
                            "${widget.dehiscentdf.nutrition[i]}",
                            style:
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid2.add("${widget.dehiscentdf.id}");
                            //print("${Listitemproduc}");
                            print("setid2: ${setid2}");
                            for (int i = 0; i < setid2.length; i++) {
                              for (int j = 0; j < dehiscentdf.length; j++) {
                                if (setid2[i] == "${dehiscentdf[j].id}") {
                                  savedatadryfruit.add(dehiscentdf[j].title);
                                  savedatadryfruit.add(dehiscentdf[j].price);
                                  savedatadryfruit.add(dehiscentdf[j].image);
                                  savedatadryfruit.add(dehiscentdf[j].phanloai);
                                }
                              }
                            }
