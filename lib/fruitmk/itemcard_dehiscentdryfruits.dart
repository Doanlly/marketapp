...
class ItemcarddehiscentDF extends StatefulWidget {
  var press;

  ItemcarddehiscentDF(
      {Key? key, required this.dehiscentdfz, required this.press})
      : super(key: key);
  final DehiscentDryFruits dehiscentdfz;

  //get press => null;
  //Function press;

  @override
  State<ItemcarddehiscentDF> createState() => _ItemcarddehiscentDFState();
}

class _ItemcarddehiscentDFState extends State<ItemcarddehiscentDF> {
        ...
        children: [
                    ...
                    child: InkWell(
                        onTap: () {
                          ...
                          if (checkfavorrite == false) {
                            setidf.add("${widget.dehiscentdfz.id}");
                            //print("${Listitemproduc}");
                            print("setid: ${setidf}");
                            for (int i = 0; i < setidf.length; i++) {
                              for (int j = 0; j < dehiscentdf.length; j++) {
                                if (setidf[i] == "${dehiscentdf[j].id}") {
                                  savedataproductf.add(dehiscentdf[j].title);
                                  savedataproductf.add(dehiscentdf[j].price);
                                  savedataproductf.add(dehiscentdf[j].image);
                                  savedataproductf.add(dehiscentdf[j].phanloai);
                                }
                              }
                            }
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              Text(
                "${widget.dehiscentdfz.price} Per/ kg",
