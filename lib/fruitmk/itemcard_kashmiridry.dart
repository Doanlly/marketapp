                    ...
                    child: InkWell(
                        onTap: () {
                          ...
                          if (checkfavorrite == false) {
                            setidf.add("${widget.kashmiridfs.id}");
                            //print("${Listitemproduc}");
                            print("setid: ${setidf}");
                            for (int i = 0; i < setidf.length; i++) {
                              for (int j = 0; j < kashmiridf.length; j++) {
                                if (setidf[i] == "${kashmiridf[j].id}") {
                                  savedataproductf.add(kashmiridf[j].title);
                                  savedataproductf.add(kashmiridf[j].price);
                                  savedataproductf.add(kashmiridf[j].image);
                                  savedataproductf.add(kashmiridf[j].phanloai);
                                }
                              }
                            }
