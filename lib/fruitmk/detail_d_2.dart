...
class DetailscreenD3 extends StatefulWidget {
  const DetailscreenD3({Key? key, required this.mixedf}) : super(key: key);

  final MixeddeyFruits mixedf;
  @override
  State<DetailscreenD3> createState() => _DetailscreenStatez();
}

class _DetailscreenStatez extends State<DetailscreenD3> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: widget.mixedf.nutrition.length,
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid2.add("${widget.mixedf.id}");
                            //print("${Listitemproduc}");
                            print("setid2: ${setid2}");
                            for (int i = 0; i < setid2.length; i++) {
                              for (int j = 0; j < mixerdryfruit.length; j++) {
                                if (setid2[i] == "${mixerdryfruit[j].id}") {
                                  savedatadryfruit.add(mixerdryfruit[j].title);
                                  savedatadryfruit.add(mixerdryfruit[j].price);
                                  savedatadryfruit.add(mixerdryfruit[j].image);
                                  savedatadryfruit
                                      .add(mixerdryfruit[j].phanloai);
                                }
                              }
                            }
