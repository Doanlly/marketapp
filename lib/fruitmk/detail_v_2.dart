              ...
              child: Column(
                children: [
                  ...
                  Align(
                      ...
                      child: Text("${widget.mixedvgt.title}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600),))
                    ,),
                  Padding(padding: EdgeInsets.only(left: 25),child:
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text("${widget.mixedvgt.detail}",style: TextStyle(fontSize: 14,color: Colors.black54),),
                  )
                    ,),
                      ...
                      itemBuilder: (context,i){
                        return
                          ...
                          Row(children: [
                            ...
                            Text("${widget.mixedvgt.nutrition[i]}",style: TextStyle(fontSize: 14,color: Colors.black45),)
                          ],);
                      },),
                  ),
