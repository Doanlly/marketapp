...
class DetailscreenV2 extends StatefulWidget {
  const DetailscreenV2({Key? key, required this.mixedvgt}) : super(key: key);

  final Mixedvegetables mixedvgt;
  @override
  State<DetailscreenV2> createState() => _DetailscreenStatez();
}

class _DetailscreenStatez extends State<DetailscreenV2> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: widget.mixedvgt.nutrition.length,
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            setid1.add("${widget.mixedvgt.id}");
                            print("${Listitemproduc}");
                            print("setid1: ${setid1}");
                            for (int i = 0; i < setid1.length; i++) {
                              for (int j = 0; j < mixedvegt.length; j++) {
                                if (setid1[i] == "${mixedvegt[j].id}") {
                                  savedatavegatables.add(mixedvegt[j].title);
                                  savedatavegatables.add(mixedvegt[j].price);
                                  savedatavegatables.add(mixedvegt[j].image);
                                  savedatavegatables.add(mixedvegt[j].phanloai);
                                }
                              }
                            }
